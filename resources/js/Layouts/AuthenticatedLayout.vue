<template>
    ...
    <div>
        ...
        <Toast
            v-for="flashType in Object.keys($page.props.flash)"
            v-if="$page.props.flash && $page.props.flash[flashType] !== null"
            :key="`flashType_${flashType}`"
        >
            <template #title>Success</template>
            <template #message>
                {{ $page.props.flash[flashType] }}
            </template>
        </Toast>
    </div>
</template>
